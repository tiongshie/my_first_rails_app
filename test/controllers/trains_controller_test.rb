...
class TrainsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create train" do
    assert_difference('Train.count') do
      post trains_url, params: { train: { make: @train.make, model: @train.model, year: @train.year } }
    end
  ...
  test "should update train" do
    patch train_url(@train), params: { train: { make: @train.make, model: @train.model, year: @train.year } }
